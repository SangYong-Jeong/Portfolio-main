  ...
  return (
    <Wrapper ref={wrapper}>
      ...
      <Content>
        ...
        브라우저 밖에서 javascript를 실행할 수 있는 Nodejs를 학습했습니다. 이를
        바탕으로 웹 애플리케이션 서버를 구축하는 프레임워크인 express를 이용해
        웹 애플리케이션 서버를 구축했고 프로젝트를 진행하면서 REST API 및 MVC
        Pattern, MySQL 그리고 여러 모듈들에 대해 학습했습니다. 프로젝트
      ...
      <Content mb={'5em'}>
        ...
        느끼게 되었고 현재는 따로 React 및 Vue에 대한 학습을 이어가고 있습니다.
      </Content>
      <ProgressWrapperCp />
    </Wrapper>
  );
